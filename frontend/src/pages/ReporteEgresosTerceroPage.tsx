...
export const ReporteEgresosTerceroPage = () => {
    ...
    const [grupoId, setGrupoId] = useSessionStorage('rep_egresos_grupoId', '')
    ...
    const handleGrupoClick = (item: ItemDesglose) => {
        setConceptoModal({
            ...
            parentId: item.id,
            grandParentId: grupoModal.parentId,
            data: [],
            isOpen: true,
            sortAsc: false,
            sortField: 'egresos'
